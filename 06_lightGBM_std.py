...
fh = logging.FileHandler('./output/lightgbm_std.log')
...
train_X = standardize_lr(train_X)
valid_X = standardize_lr(valid_X)
test_X = standardize_lr(test_X)
test_mid_X = standardize_lr(test_mid_X)
